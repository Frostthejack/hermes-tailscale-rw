...
| **WSL↔Windows config migration** | `references/wsl-windows-config-migration.md` — Cross-platform config comparison, gap analysis, and safe merge strategy |
| **Discord slash commands** | `references/discord-slash-commands.md` — Pattern for adding custom Discord slash commands (OSINT tools, utilities, etc.) to the gateway |
